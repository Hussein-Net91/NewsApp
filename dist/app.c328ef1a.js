...
document.addEventListener('DOMContentLoaded', function () {
  ...
  search.addEventListener('keyup', function (event) {
    ...
    if (event.key == 'Enter') {
      ...
      getNews(search.value); // window.location.pathname= search.value
...
function updateUI(content) {
  news.innerHTML = content; // select all the div with class name of upvote 
  ...
  for (var index = 0; index < upvote.length; index++) {
    upvote[index].addEventListener('click', function (event) {
      var varable = 'counter' + event.target.id; // console.log(document.getElementById(varable).innerText)
...
function createArticle(article, i) {
  article.counter = 0;
  return "\n\n    <article id=\"".concat(i, "\">\n    <div width=\"124px\" height=\"150px\" position: relative display: inline-block>\n      <img width=\"124px\" height=\"150px\" src=\"").concat(article.urlToImage, "\" alt=\"\">\n      </div>\n      <div id=\"text\">\n        <h1>").concat(article.title, "</h1>\n       \n        <div>\n        <p>").concat(article.description, "</p>\n        </div>\n        <time>").concat(article.publishedAt, "</time>\n      </div>\n      <div id=\"voter\" >\n        <img height=\"13px\" id=\"").concat(i, "\" class=\"upvote\" src=\"").concat(require('./assets/upvote.svg'), "\" alt=\"\">\n        <div id=\"counter").concat(i, "\">").concat(article.counter, "</div>\n        <img  height=\"13px\" id=\"").concat(i, "\" class=\"downvote\" src=\"").concat(require('./assets/downvote.svg'), "\" alt=\"\">\n      </div>\n    </article>\n  ");
}
